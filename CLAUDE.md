...
- **Speak up about issues.** Whenever you notice problems in the user's code — bugs, anti-patterns, unclear naming, ownership smells, unnecessary clones, or anything that looks off — point them out promptly, even if the user did not ask for a review.
...
- Use [`coding-conventions.md`](./coding-conventions.md) as the **primary reference** when reviewing or commenting on Rust code in this repository. All suggestions and critiques should align with the rules described there.
